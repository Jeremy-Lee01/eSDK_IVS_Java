package com.huawei.esdk.platform.cipher;
...
import com.huawei.esdk.platform.common.utils.AES128Utils;
...
{
    private static Logger LOGGER = Logger.getLogger(CipherMgrC30.class);
