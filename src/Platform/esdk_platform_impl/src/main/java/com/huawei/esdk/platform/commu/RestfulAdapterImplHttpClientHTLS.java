...
public class RestfulAdapterImplHttpClientHTLS implements ISDKProtocolAdapter
{
    private static Logger LOGGER = Logger.getLogger(RestfulAdapterImplHttpClientHTLS.class);
    ...
    public RestfulAdapterImplHttpClientHTLS(String serverUrl)
    {
        ...
        if (serverUrl.startsWith(ESDKConstant.PROTOCOL_ADAPTER_TYPE_HTTPS))
        {
            try
            {
                ...
                SSLContext ctx = SSLContext.getInstance(ESDKConstant.SSL_SECURE_SOCKET_PROTOCOL_TLS11);
        ...
        throws ProtocolAdapterException
    {
        ...
        try
        {
            ...
            ThreadLocalHolder.get()
                .getEntities()
                .put("HTTP_RES_CODE", String.valueOf(response.getStatusLine().getStatusCode()));
