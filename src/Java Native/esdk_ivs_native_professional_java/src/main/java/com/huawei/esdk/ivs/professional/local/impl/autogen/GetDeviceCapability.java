 ...
 *       &lt;sequence>
 *         &lt;element name="capabilityType" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "getDeviceCapability")
public class GetDeviceCapability {

    @XmlElement(required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "int")
    protected Integer capabilityType;
     ...
     *     
     */
    public void setCapabilityType(Integer value) {
