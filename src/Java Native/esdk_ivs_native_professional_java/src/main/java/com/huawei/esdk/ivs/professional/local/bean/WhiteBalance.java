...
public class WhiteBalance {
    ...
    protected Integer whiteBalanceMode;
    @XmlElement(required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "int")
    protected Integer redGain;
    @XmlElement(required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "int")
    protected Integer blueGain;
     ...
     *     
     */
    public void setWhiteBalanceMode(Integer value) {
     ...
     *     
     */
    public void setRedGain(Integer value) {
        this.redGain = value;
    }
     ...
     *     
     */
    public void setBlueGain(Integer value) {
        this.blueGain = value;
    }
