...
import com.huawei.esdk.ivs.professional.local.bean.PTZPresetInfoList;
...
import com.huawei.esdk.ivs.professional.local.impl.autogen.GetRtspURL;
...
public class BusinessManagerServiceExImpl implements BusinessManagerServiceEx
{
	...
	@Override
	public IVSSDKResponse<String> getRtspURL(String cameraCode, MediaURLParam mediaURLParam)
	{
		LOGGER.info("begin to execute getRtspURL method");
		IVSSDKResponse<String> result = new IVSSDKResponse<String>();
		
		GetRtspURL getRtspURL = new GetRtspURL();
		getRtspURL.setCameraCode(cameraCode);
		getRtspURL.setMediaURLParam(mediaURLParam);
        ...
        try
        {
        	ivsProfessionalBusinessManager.getRtspURL(cameraCode, mediaURLParam, resultCode, rtspURL);
            LOGGER.info("execute getRtspURL method completed");
            
        }
        catch (Exception e)
        {
            LOGGER.error("getRtspURL method exception happened", e);
            ExceptionUtils.processSoapException(result, e);
            return result;
        }
        
        result.setResultCode(resultCode.value);
        result.setResult(rtspURL.value);
