...
public class RecordPlan {
    ...
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "int")
    protected Integer enableRecordPlan;
    @XmlElement(required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "int")
    protected Integer recordPlanType;
    @XmlElement(required = true)
    protected String reserve;
    @XmlElement(required = true, type = String.class)
    @XmlJavaTypeAdapter(Adapter3 .class)
    @XmlSchemaType(name = "int")
    protected Integer planInfoNum;
    @XmlElement(required = true)
     ...
     *     
     */
    public Integer getEnableRecordPlan() {
     ...
     *     
     */
    public void setEnableRecordPlan(Integer value) {
     ...
     *     
     */
    public Integer getRecordPlanType() {
     ...
     *     
     */
    public void setRecordPlanType(Integer value) {
     ...
     *     
     */
    public void setPlanInfoNum(Integer value) {
