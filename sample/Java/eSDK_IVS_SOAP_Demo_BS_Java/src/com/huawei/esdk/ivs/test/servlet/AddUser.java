...
import com.huawei.esdk.ivs.test.ServiceFactoryEx;
...
public class AddUser extends HttpServlet
{
	...
	public static CommonServiceEx commonServiceEx = ServiceFactoryEx
			.getService(CommonServiceEx.class);
	public static UserManagerServiceEx userManagerServiceEx = ServiceFactoryEx
			.getService(UserManagerServiceEx.class);
